...
- Visible focus indicators on all focusable elements (don't remove `outline`)
...
- Verify ARIA usage in browser accessibility tree
...
- [ ] Color contrast checker (DevTools built-in)
